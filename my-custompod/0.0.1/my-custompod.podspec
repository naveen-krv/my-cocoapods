#
#  Be sure to run `pod spec lint my-custompod.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "my-custompod"
  spec.version      = "0.0.1"
  spec.summary      = "My custom pod"
  ...
  spec.homepage     = "https://github.com/naveen-krv/custom_pod"
  ...
  spec.source_files  = "custom_pod/custom_pod/**/*.{swift}"
